...
Accessibility is just a way to make sure that as many people can read your site as possible regardless of any kind of disability they may have. 

2. Talk about 3 different things you can do to ensure your website is accessible. 

1. Make sure it can be used on all kinds of screens 2. Use screen readers so people  that are visually impaired are able to use the site. 3.  Write easy to understand content for people with cognitive impairments.

3. How would you explain the concept of a variable to someone new to programming?

A variable is a container to hold data or information for later use.
